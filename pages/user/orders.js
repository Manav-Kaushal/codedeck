...
const Orders = () => {
  ...
  return (
    <div className="bg-white">
      <div className="py-16">
        <div className="max-w-screen-2xl mx-auto sm:px-2 lg:px-8">
        ...
        <div className="mt-12">
          ...
          <div className="max-w-screen-2xl mx-auto sm:px-2 lg:px-8">
            <div className="group max-w-screen-2xl mx-auto space-y-8 sm:px-4 lg:px-0 transition-200 shadow-md hover:shadow-lg">
              {orders.map((order) => (
                <div
                  key={order.number}
                      ...
                      <li key={product.id} className="p-4 sm:p-6">
                        <div className="flex items-center sm:items-start">
                          ...
                          <div className="flex-1 ml-6 text-sm">
                            <div className="font-semibold text-gray-900 sm:flex sm:justify-between">
                              <h5>{product.name}</h5>
